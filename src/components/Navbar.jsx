...
// // // then it becomes available at "/logo-bat-swing.gif"
...
// //             <div className="w-11 h-11 rounded-xl bg-gradient-to-br from-willow to-willow-light flex items-center justify-center overflow-hidden shadow-md ring-1 ring-white/10 group-hover:scale-105 transition-transform duration-300">
// //               {!logoError ? (
// //                 <img
// //                   src={LOGO_SRC}
...
// //                 />
// //               ) : (
// //                 // fallback if the gif isn't found — keeps the site from breaking
// //                 <span className="text-pitch font-black text-xl">🏏</span>
// //               )}
// //             </div>
// //             <div>
...
//           {/* Desktop Nav Links */}
//           <nav className="hidden lg:flex items-center gap-8 text-[13px] font-semibold uppercase tracking-wide ml-10">
//             {navCategories.map((cat) => {
//               const isActive = activeCategory === cat.filter
//               return (
//                 <button
...
//             <a
//               href="#craftsmanship"
//               className="whitespace-nowrap text-linen/70 hover:text-willow transition-colors"
//             >
//               Knocking Lab
//             </a>
//             <a
    ...
    <header className="sticky top-0 z-40 w-full max-w-full overflow-x-hidden shadow-lg">
      ...
      <div className="bg-pitch/95 backdrop-blur-md text-linen border-b border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-20">
          ...
          {/* Desktop Nav Links */}
          <nav className="hidden lg:flex items-center gap-5 xl:gap-6 text-[13px] font-semibold ml-6 min-w-0">
            {navCategories.map((cat) => {
              const isActive = activeCategory === cat.filter
              return (
                <button
